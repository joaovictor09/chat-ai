...
export function Message({ role, content }: MessageProps) {
  return (
    ...
    >
      <div className="flex justify-center px-5 lg:px-0 max-w-3xl w-full gap-3 text-slate-600 text-sm">
        {role === 'user' && (
          <Avatar>
